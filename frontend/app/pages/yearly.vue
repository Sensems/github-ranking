...
import yearlyData from '~/data/leaderboards/yearly.json'
import { useLeaderboard } from '~/composables/useLeaderboard'
import type { LeaderboardPayload } from '~/types/leaderboard'

const payload = yearlyData as LeaderboardPayload
...
<template>
  <div>
    <LeaderboardTabs />
    <h1 class="mb-4 text-lg font-bold text-gray-900">年增速榜</h1>
    ...
    <div class="grid gap-4">
      <RepoCard v-for="item in sorted" :key="item.repo_id" :item="item" board-type="yearly" />
    </div>
  </div>
</template>
